...
class Normalization {
  ...
  /// - [sensitivity], a `double` clamped between `0..1`, that influences the
  /// maximum `List` length for a sensors data samples buffer.
  ...
  /// - [compensation], an amount to shear from raw `AccelerometerEvent` data
